...
<head>
    ...
    <link rel="stylesheet" href="/public/ace/assets/css/ace-skins.min.css" />
    ...
    <script src="/public/ace/assets/js/ace-extra.min.js"></script>
...
<li class="green">
    ...
    <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
        ...
        <li>
            <a href="#">
                <img src="/public/ace/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
										<span class="msg-body">
        ...
        <li>
            <a href="#">
                <img src="/public/ace/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
        ...
        <li>
            <a href="#">
                <img src="/public/ace/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
...
<li class="light-blue">
    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
        <img class="nav-user-photo" src="/public/ace/assets/avatars/user.jpg" alt="Jason's Photo" />
    ...
    <c:forEach items="${SESSION_LOGIN_MENU}" var="menu">
        <li >
            ...
            <a href="#" class="dropdown-toggle">
                ...
                <span class="menu-text"> ${menu.menu1.node_name} </span>
